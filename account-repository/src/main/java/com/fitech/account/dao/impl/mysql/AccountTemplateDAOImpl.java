...
//
//import com.fitech.domain.ledger.*;
//import com.fitech.framework.lang.util.StringUtil;
//import com.fitech.ledger.dao.LedgerReportTemplateDAO;
//import com.fitech.validate.domain.ValidateBatch;
//import com.fitech.vo.ledger.LedgerReportVo;
//import com.fitech.vo.ledger.ValidateResultParameter;
//import com.fitech.vo.ledger.ValidateResultVo;
...
// */
//public class AccountTemplateDAOImpl extends NamedParameterJdbcDaoSupport implements LedgerReportTemplateDAO {
//    @Autowired
...
//
//
//    public void createTemplate(LedgerReportTemplate ledgerReportTemplate) {
//        String tableName = ledgerReportTemplate.getTableName().toUpperCase();
...
//
//        createTemplate(tableName,ledgerReportTemplate);
//        createTemplate(history,ledgerReportTemplate);
//        createTemplate(standard,ledgerReportTemplate);
//        createTemplate(origin,ledgerReportTemplate);
//        createTemplate(zipper,ledgerReportTemplate);
//    }
//    /**
//     * 初始化数据表结构
//     *
...
//     */
//    private void createSQL(StringBuffer sql, LedgerReportTemplate ledgerReportTemplate) {
//        sql.append("ID BIGINT NOT NULL AUTO_INCREMENT,reportId bigint NOT NULL,PRIMARY KEY(ID),");
//        Collection<LedgerItem> items = new ArrayList<>();
//        items = ledgerReportTemplate.getItems();
//        if (items != null) {
...
//    }
//
//    private void createTemplate(String tableName,LedgerReportTemplate ledgerReportTemplate){
...
//            }
//            sb.append(" AND D.GATHER_DATE='" + vo.getGatherDate() + "'")
//                    .append(" And t2.check_rule_id='" + vo.getRuleId() + "'")
//                    .append(" AND  D.ID=t1.details_key_group")
//                    .append(" AND t2.validate_column='" + vo.getItemCode() + "')a");
//        } else {
...
//
//    @Transactional
//    public void dropTemplate(LedgerReportTemplate ledgerReportTemplate) {
//        String sql = "DROP TABLE IF EXISTS " + ledgerReportTemplate.getTableName();
//        this.getNamedParameterJdbcTemplate().update(sql, new HashMap<String, String>());
//    }
//
//    @Override
...
//        sb.append(" and f.ledgerReportTemplate_id=" + id);
...
//
//    @Override
//    public Boolean dataIsExist(LedgerReportTemplate ledgerReportTemplate) {
//        Boolean flag = false;
//        String s = "select count(*) from " + ledgerReportTemplate.getTableName();
...
//
//    @Override
//    public void dropAllTemplate(LedgerReportTemplate ledgerReportTemplate) {
//        String sql1 = "DROP TABLE IF EXISTS " + ledgerReportTemplate.getTableName();
//        this.getNamedParameterJdbcTemplate().update(sql1, new HashMap<String, String>());
//        String sql2 = "DROP TABLE IF EXISTS " + ledgerReportTemplate.getTableName() + "_" + TableNameType.HISTORY.getTableName();
//        this.getNamedParameterJdbcTemplate().update(sql2, new HashMap<String, String>());
//        String sql3 = "DROP TABLE IF EXISTS " + ledgerReportTemplate.getTableName() + "_" + TableNameType.STANDARD.getTableName();
//        this.getNamedParameterJdbcTemplate().update(sql3, new HashMap<String, String>());
//        String sql4 = "DROP TABLE IF EXISTS " + ledgerReportTemplate.getTableName() + "_" + TableNameType.ORIGIN.getTableName();
//        this.getNamedParameterJdbcTemplate().update(sql4, new HashMap<String, String>());
//    }
//
//
//    @Override
...
//        Boolean flag = false;
//        StringBuffer sb = new StringBuffer();
//        sb.append("select count(*) from Role r,User_Role ur ");
...
//            sql.append(" AND d.GATHER_DATE='" + vp.getGatherDate() + "')");
//        }
...
//            sb.append(" AND D.cjrq='" + vo.getGatherDate() + "'");
//        }
//        sb.append(" And t2.check_rule_id='" + vo.getRuleId() + "'");
//        sb.append(" AND  D.ID=t1.details_key_group");
//        sb.append(" AND t2.validate_column='" + vo.getItemCode() + "'");
...
//		String sql = "insert into :tableName select * from :metadataTable where reportId=:reportId";
//		Map<String, Object> params = new HashMap<String, Object>();
//		params.put("tableName", tableName);
//		params.put("metadataTable", ledgerReport.getLedgerReportTemplate().getTemplateCode());
//		params.put("reportId", ledgerReport.getId());
